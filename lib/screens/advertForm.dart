...
class _CreateAdvertFormState extends State<CreateAdvertForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create Advert', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        leading: IconButton(
        ...
        child: Stepper(
          ...
          steps: [
            Step(
              ...
              content: Column(
                children: [
                  _buildDropdown('Vehicle Brand', _selectedBrand, ['Brand A', 'Brand B'], (value) {
                    setState(() {
                      _selectedBrand = value;
                    });
                  }),
                  _buildDropdown('Model', _selectedModel, ['Model X', 'Model Y'], (value) {
                    setState(() {
                      _selectedModel = value;
                    });
                  }),
                  _buildDropdown('Year of Registration', _selectedYear, ['2020', '2021'], (value) {
                    setState(() {
                      _selectedYear = value;
                    });
                  }),
                  ...
                  _buildDropdown('Condition', _selectedCondition, ['New', 'Used'], (value) {
                    setState(() {
                      _selectedCondition = value;
                    });
                  }),
                  _buildDropdown('Engine', _selectedEngine, ['1.4L', '2.0L'], (value) {
                    setState(() {
                      _selectedEngine = value;
                    });
                  }),
                  _buildDropdown('Color', _selectedColor, ['Red', 'Blue'], (value) {
                    setState(() {
                      _selectedColor = value;
                    });
                  }),
                  _buildDropdown('Body Type', _selectedBodyType, ['Sedan', 'SUV'], (value) {
                    setState(() {
                      _selectedBodyType = value;
                    });
                  }),
                  _buildDropdown('Gear Box', _selectedGearBox, ['Automatic', 'Manual'], (value) {
                    setState(() {
                      _selectedGearBox = value;
                    });
                  }),
                  _buildDropdown('Fuel Type', _selectedFuelType, ['Petrol', 'Diesel'], (value) {
                    setState(() {
